...
To login using username/password, go to https://dysleksi-web/login/forward/django instead.

| Role                                    | Login type        | Teacher username | Teacher password |
|-----------------------------------------|:------------------|------------------|------------------|
| Teacher 1                               | UniLogin/MitID    | `laerer@dys.gl`  | `laerer`         |
