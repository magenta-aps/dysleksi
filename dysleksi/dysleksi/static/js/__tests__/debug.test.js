...
describe("DebugConsole", () => {
  ...
  beforeEach(() => {
    ...
    Object.defineProperty(global.navigator, "userAgent", { value: "Mozilla/5.0", configurable: true });
  ...
  it("should handle unhandled promise rejections", () => {
    ...
    window.dispatchEvent(
      new PromiseRejectionEvent("unhandledrejection", { reason, promise: dummyPromise })
    );
    const lastLine = logbox.lastChild.textContent;
  ...
  it("should NOT hide logbox on iPad", () => {
    Object.defineProperty(global.navigator, "userAgent", { value: "iPad", configurable: true });
