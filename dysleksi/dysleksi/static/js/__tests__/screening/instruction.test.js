...
describe("InstructionSequenceRunner", () => {
    ...
    it("executeInstruction calls correct DOM method for each action", async () => {
        ...
        expect(domElements.showElement).toHaveBeenCalledWith(
            document.getElementById("el1"),
        );
        expect(domElements.hideElement).toHaveBeenCalledWith(
            document.getElementById("el1"),
        );
        expect(domElements.fadeIn).toHaveBeenCalledWith(document.getElementById("el1"));
        expect(domElements.fadeOut).toHaveBeenCalledWith(
            document.getElementById("el1"),
        );
        expect(domElements.highlight).toHaveBeenCalledWith(
            document.getElementById("el1"),
        );
    ...
    it("set repeatbutton destination", () => {
        ...
        runner.executeInstruction({
            action: "setRepeatButtonDestination",
            element: "btn1",
            data: "3",
        });
    ...
    it("set element text", () => {
        ...
        expect(domElements.setText).toHaveBeenCalledWith(
            document.getElementById("el1"),
            "test",
        );
    });
